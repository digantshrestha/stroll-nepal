-- drop database if exists strolling;
-- create database strolling;
-- use strolling;
...
-- place_lat varchar(5), place_long varchar(5), place_ratings varchar(10) null, 
-- place_details text, place_tips text, added_date timestamp default CURRENT_TIMESTAMP, 
-- modified_date timestamp null, status boolean, country_id bigint unsigned);
...
-- activity_category bigint unsigned, price varchar(20), duration varchar(10), 
-- activity_info text, place_id bigint unsigned, added_date timestamp default CURRENT_TIMESTAMP,
...
-- hotel_ratings varchar(10) null, hotel_especiality text, hotel_reviews text,
-- added_date timestamp default CURRENT_TIMESTAMP, modified_date timestamp null, 
-- per_night_exp varchar(20), place_id bigint unsigned, status boolean);
...
-- restaurant_ratings varchar(10) null, restaurant_especiality text, restaurant_reviews text, 
-- added_date timestamp default CURRENT_TIMESTAMP, modified_date timestamp null, 
-- avg_exp varchar(20), place_id bigint unsigned, status boolean);
...
-- img_path varchar(100), details text null, user_id bigint unsigned, 
-- added_date timestamp default CURRENT_TIMESTAMP, modified_date timestamp null, 
-- place_id bigint unsigned, status boolean);
...
-- added_date timestamp default CURRENT_TIMESTAMP, modified_date timestamp null,
-- email_verified boolean default 0, status boolean);
